import { NotionConverter } from "@/app/components/NotionConverter";
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start max-w-2xl w-full">
        ...
        <div className="text-sm text-center sm:text-left space-y-2">
          ...
          <ol className="list-decimal list-inside space-y-1">
            ...
            <li>Click convert to see the markdown content</li>
            <li>Copy the markdown content to use elsewhere</li>
          </ol>
        </div>
      </main>
    </div>
